...
class IconBox extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Icon Box', 'unlimited-elementor-inner-sections-by-boomdevs');
    }
    
    public function get_icon() {
        return 'pea_icon_box_icon';
    }
    ...
    public function get_style_depends() {
        return ['prime-elementor-addons--icon-box'];
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'default' => 'center',
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-media-container' => 'justify-content: {{VALUE}};',
                    ],
                    'render_type'  => 'template',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => 'column',
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-wrapper-inner' => 'flex-direction: {{VALUE}};',
                    ],
                    'render_type'  => 'template',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'default' => 'start',
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-wrapper-inner' => 'justify-content:   {{VALUE}};',
                    ],
                    'render_type'  => 'template',
                    'conditions' => [
                        'relation' => 'or',
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'default' => 'start',
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-media-container' => 'align-items: {{VALUE}};',
                    ],
                    'render_type'  => 'template',
                    'conditions' => [
                        'relation' => 'or',
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => 'fill',
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-wrapper-inner img' => 'object-fit: {{VALUE}};',
                    ],
                    'condition' => [
                        'media_type' => 'image',
                    ],
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-title' => 'text-align: {{VALUE}};',
                    ],
                    'default' => 'center',
                    'render_type'  => 'template',
                ]
            ...
            $this->add_control(
                ...
                [
                    ...
                    'placeholder' => esc_html__( 'Type Icon box title here', 'unlimited-elementor-inner-sections-by-boomdevs' ),
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-description' => 'text-align: {{VALUE}};',
                    ],
                    'default' => 'center',
                    'render_type'  => 'template',
                ]
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-btn-container' => 'text-align: {{VALUE}};',
                    ],
                    'default' => 'center',
                    'render_type'  => 'template',
                    'condition' => [
		...
		$this->start_controls_section(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'selector'  => '{{WRAPPER}} .pea-icon-box-wrapper',
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'fields_options' => [
                                ...
                                'color' => [
                                    'default' => '#d7ebff', // ✅ Set your default normal color here
                                ],
                            ],
                            'selector'  => '{{WRAPPER}} .pea-icon-box-wrapper:hover',
                        ]
                    );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            ); 
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors'       => [
                        '{{WRAPPER}} .pea-icon-media-wrapper img' => 'width: {{SIZE}}{{UNIT}}; max-width: {{SIZE}}{{UNIT}};',
                    ],
                    'condition' => [
                        'media_type' => 'image',
                    ],
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors'       => [
                        '{{WRAPPER}} .pea-icon-media-wrapper img' => 'height: {{SIZE}}{{UNIT}};',
                    ],
                    'condition' => [
                        'media_type' => 'image',
                    ],
            ...
            $this->start_controls_tab(
                ...
                $this->add_group_control(
                    ...
                    [
                        ...
                        'selector'  => '{{WRAPPER}} .pea-icon-media-wrapper',
                    ]
                );
            ...
            $this->start_controls_tab(
                ...
                $this->add_group_control(
                    ...
                    [
                        ...
                        'selector'  => '{{WRAPPER}} .pea-widget-wrapper:hover .pea-icon-media-wrapper',
                    ]
                );
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .pea-widget-wrapper:hover .pea-icon-media-wrapper' => 'border-color: {{VALUE}}',
                        ],
                    ]
                );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-media-wrapper' => 'border-radius: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-media-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-media-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-media-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .pea-icon-box-title',
                    'fields_options' => [
                        'typography' => [
                            'default' => 'custom',
                        ],
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '#15171C',
                            'selectors' => [
                                '{{WRAPPER}} .pea-icon-box-title' => 'color: {{VALUE}};',
                            ]
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '',
                            'selectors' => [
                                '{{WRAPPER}} .pea-widget-wrapper:hover .pea-icon-box-title' => 'color: {{VALUE}};',
                            ]
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pea-widget-wrapper:hover .pea-icon-box-title' => 'border-color: {{VALUE}};',
                            ]
                        ]
                    );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-title' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .pea-icon-box-description',
                    'fields_options' => [
                        'typography' => [
                            'default' => 'custom',
                        ],
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '#555E72',
                            'selectors' => [
                                '{{WRAPPER}} .pea-icon-box-description' => 'color: {{VALUE}};',
                            ]
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '',
                            'selectors' => [
                                '{{WRAPPER}} .pea-widget-wrapper:hover .pea-icon-box-description' => 'color: {{VALUE}};',
                            ]
                        ]
                    );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-description' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-box-description' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .pea-icon-btn-wrapper',
                    'fields_options' => [
                        'typography' => [
                            'default' => 'custom',
                        ],
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '#399CFF',
                            'selectors' => [
                                '{{WRAPPER}} .pea-icon-btn-wrapper' => 'color: {{VALUE}}',
                            ],
                            'condition' => [
                                'show_button' => 'yes',
                            ],
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pea-icon-btn-wrapper' => 'background-color: {{VALUE}}',
                            ],
                            'condition' => [
                                'show_button' => 'yes',
                            ],
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '',
                            'selectors' => [
                                '{{WRAPPER}} .pea-widget-wrapper:hover .pea-icon-btn-wrapper' => 'color: {{VALUE}}',
                            ],
                            'condition' => [
                                'show_button' => 'yes',
                            ],
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pea-widget-wrapper:hover .pea-icon-btn-wrapper' => 'background-color: {{VALUE}}',
                            ],
                            'condition' => [
                                'show_button' => 'yes',
                            ],
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pea-widget-wrapper:hover .pea-icon-btn-wrapper' => 'border-color: {{VALUE}};',
                            ]
                        ]
                    );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-btn-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-btn-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .pea-icon-btn-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
    ...
    protected function render() {
        ...
        $box_icon = isset($settings['box_icon']) ? $settings['box_icon'] : '' ; 
        ...
        ?>
        <div class="pea-widget-wrapper pea-icon-box-wrapper <?php echo esc_attr($preset_styles); ?>" >
            <div class="pea-icon-box-wrapper-inner">
                <div class="pea-icon-media-container">
                    <div class="pea-icon-media-wrapper">
                        <?php if($settings['media_type'] === 'icon'){ ?>
                            <div class="pea-icon-wrapper">
                                <?php \Elementor\Icons_Manager::render_icon( $box_icon, [ 'aria-hidden' => 'true' ] ); ?>
                            </div>
                        <?php }else{ $image_url = $settings['icon_box_image']['url']; ?> 
                ...
                <div class="pea-icon-box-content-wrapper">
                    ...
                    <?php if($settings['show_button'] === 'yes'){ 
                        ...
                        <div class="pea-icon-button">
                            <div class="pea-icon-btn-container">
                                <a class="pea-icon-btn-wrapper" 
