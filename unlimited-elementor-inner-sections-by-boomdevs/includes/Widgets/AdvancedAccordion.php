...
?>
        <#
            ...
            view.addRenderAttribute( accordionItemKey, { 'class' : itemClass, 'accordion-index' : accordionCount, 'role' : 'group' ,
            } );

            view.addRenderAttribute( accordionContentKey, { 'class' : 'pea-accordion-content' ,
            } );
            #>
                                ...
                                <div class="pea-accordion-item-title-wrapper <?php echo esc_attr($is_active); ?>">
                                    <div class="pea-accordion-title-inner">
                                        <?php if ($accordion['accordion_item_title_prefix_choose_icon_or_img'] !== 'none') { ?>
                                            <div class="pea-accordion-title-prefix">
                                                ...
                                                <?php } else if ($accordion['accordion_item_title_prefix_choose_icon_or_img'] === 'image') {
                                                    $image_url = $accordion['accordion_item_title_prefix_image']['url']; ?>
                                        ...
                                        <?php if ($accordion['accordion_item_title_suffix_choose_icon_or_img'] !== 'none') { ?>
                                            <div class="pea-accordion-title-suffix">
                                                ...
                                                <?php } else if ($accordion['accordion_item_title_suffix_choose_icon_or_img'] === 'image') {
                                                    $image_url = $accordion['accordion_item_title_suffix_image']['url']; ?>
                                                    <img src="<?php echo esc_url($image_url) ?>">
                                                <?php } ?>
                                            </div>
                                        <?php } ?>
                                    ...
                                    <?php if ($settings['show_accordion_icon'] === 'yes') { ?>
                                        <div class="pea-accordion-tab-icon">
                                            ...
                                            <?php } else if ($settings['accordion_open_choose_icon_or_img'] === 'image') {
                                                $image_url = $settings['accordion_open_image']['url']; ?>
                                                <img src="<?php echo esc_url($image_url) ?>">
                                            <?php } ?>
                                        </div>
                                        <div class="pea-accordion-expanded-icon">
                                            ...
                                            <?php } else if ($settings['accordion_close_choose_icon_or_img'] === 'image') {
                                                $image_url = $settings['accordion_close_image']['url']; ?>
                                                <img src="<?php echo esc_url($image_url) ?>">
                                            <?php } ?>
                                        </div>
                                    <?php } ?>
    ...
    protected function content_template()
    {
        ?>
            <# if ( settings['accordion_items'] ) {
                ...
                view.addRenderAttribute( advancedAccordionWrapper, { 'class' : outsideWrapperClasses,
                } );

                view.addRenderAttribute( advancedAccordionContainer, { 'class' : MidWrapperClasses,
                } );

                view.addRenderAttribute( advancedAccordionInner, { 'class' : 'pea-advanced-accordion-inner-wrapper' ,
                } );
