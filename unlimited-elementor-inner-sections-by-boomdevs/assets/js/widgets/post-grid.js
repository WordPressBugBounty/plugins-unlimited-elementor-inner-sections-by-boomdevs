(function ($) {
    jQuery(window).on('elementor/frontend/init', function () {
        ...
        var PostGrid = function ($scope, $) {
            ...
            function isArchive(el) {
                return $(el).data('archive') === 1 || $(el).attr('data-archive') === '1';
            }
            ...
            function loadPosts($container, $trigger, page, mode, callback) {
                ...
                if (mode === 'append') {
                    ...
                    var isArchive = $trigger.data('archive') === 1 || $trigger.attr('data-archive') === '1';
                } else {
                    ...
                    var isArchive = $pagination.data('archive') === 1 || $pagination.attr('data-archive') === '1';
                }
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/pea_post_grid.default', PostGrid);
        elementorFrontend.hooks.addAction('frontend/element_ready/pea_archive_post_grid.default', PostGrid);
    });
})(jQuery);
