	...
	$.extend($.SmartMenus, {
		...
		prototype: {
			init: function(refresh) {
				...
				if (!refresh) {
					...
					if (this.opts.subIndicators) {
						this.$subArrow = $('<span/>').addClass('pea-sub-arrow-icon fa fa-caret-down');
			...
			destroy: function(refresh) {
				...
				if (this.opts.subIndicators) {
					this.$root.find('span.pea-sub-arrow-icon').remove();
				}
				if (this.opts.markCurrentItem) {
			...
			itemClick: function(e) {
				...
				if ($sub) {
					var subArrowClicked = $(e.target).is('.span.pea-sub-arrow-icon'),
